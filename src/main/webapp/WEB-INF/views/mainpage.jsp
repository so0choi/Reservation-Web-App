	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				<h1 class="logo">
					<a href="https://m.naver.com/" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo"><img src="img/favicon.ico"></span>
		...
		<div class="event">
							...
							<div class="container_visual">
								...
								<ul class="visual_img">
									<c:forEach items="${promotionList }" var="promotion">
										...
										<li class="item" style="background-image: url('${promotion.productImageUrl}');"><a href="#"> <span class="img_btm_border"></span> <span class="img_right_border"></span> <span class="img_bg_gra"></span>
												<div class="event_txt">
			...
			<div class="section_event_tab">
				<ul class="event_tab_lst tab_lst_min" id="menutab_ul">
						...
						<c:forEach items="${productList}" var="product" end="1">
							<li class="item"><a href="detail.html" class="item_book">
									<div class="item_preview">
										<img alt="${product.productDescription }" class="img_thumb" src="${product.productImageUrl }"> <span class="img_border"></span>
									</div>
									<div class="event_txt">
										<h4 class="event_txt_tit">
											<span>${product.productDescription }</span> <small class="sm">샤롯데 씨어터</small>
										</h4>
